...
<head>
  ...
  <title>Aplikasi Inventaris Versi 2.0</title>
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="index.php" class="brand-link">
        ...
        <span class="brand-text font-weight-light">App Inventaris 2.0</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a data-target="#myModal" data-toggle="modal" href="#myModal" class="nav-link">
                <!-- <a target='blank' href="xls-output/neraca_aset.php" class="nav-link"> -->
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="editModalLabel">Neraca Aset</h5>
              <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <div class="row">
                <div class="col"><label for="">Unduh Neraca Aset [Umum]</label> </div>
              </div>
              <div class="row">
                <div class="col"><a target='blank' href="pdf/examples/rekap_aset.php"><button type="button" class="btn btn-info btn-block"> <i class="fas fa-file-pdf"></i> Download PDF </button></a></div>
                <div class="col"><a href="xls-output/neraca_aset.php"><button type="button" class="btn btn-success btn-block"> <i class="fas fa-file-excel"></i> Download XLS </button></a></div>
              </div>
            <br>
              <?php if ($_SESSION['jenisakses'] == 'Yayasan') { ?>
                <div class="row">
                  <div class="col"><label for="">Unduh Neraca Aset [Breakdown Per Unit Kerja]</label> </div>
                </div>
                <div class="row">                  
                  <div class="col"><a href="xls-output/neraca_aset_break_unit.php"><button type="button" class="btn btn-success btn-block"> <i class="fas fa-file-excel"></i> Download XLS </button></a></div>
                </div>
    ...
    <footer class="main-footer">
      <strong>Copyright &copy; 2021 <a href="#">Yayasan Dhyana Pura</a>.</strong>
      All rights reserved.
