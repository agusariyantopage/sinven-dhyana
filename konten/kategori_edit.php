          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Formulir Ubah Kategori</h3>
              </div>  	
            		<div class="card-body">
						<!-- Isian Form -->
						<form method="post" action="aksi_kategori_edit.php">
                            <input type="hidden" name="id_kategori" value="<?= $data['id_kategori']; ?>">
							<div class="form-group">
								<label for="kategori">Kategori</label>
								<input type="text" name="kategori" value="<?= $data['kategori']; ?>" required="" id="kategori" placeholder="Masukkan Kategori . . ." class="form-control">
							</div>
