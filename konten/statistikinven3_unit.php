          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                $id = $_GET['id'];
                $grandtotal=0;
                $sql = "SELECT barang_detail.*,deskripsi,spesifikasi,nama_panjang from barang_detail,barang,unit_kerja where barang_detail.id_barang=barang.id_barang and unit_kerja.id_unit=barang_detail.id_unitkerja and barang.id_subkategori=$id AND barang_detail.id_unitkerja=$id_unit";
