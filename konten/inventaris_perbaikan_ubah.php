<?php
$id=$_GET['id_barang'];
$sql1="select barang.*,kategori,subkategori,barang_detail.* from barang,kategori,subkategori,barang_detail where barang.id_subkategori=subkategori.id_subkategori and kategori.id_kategori=subkategori.id_kategori and barang.id_barang=barang_detail.id_barang and barang.id_barang=$id";
