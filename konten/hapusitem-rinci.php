          ...
          <div class="card-body">
            ...
            <table id="input-group" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                $sql = "SELECT hapus_detail.*, barang.*, barang_detail.nilai_perolehan FROM hapus_detail,barang,barang_detail WHERE hapus_detail.id_barang=barang.id_barang  AND hapus_detail.id_barang_detail = barang_detail.id_barang_detail AND id_hapus=$id_hapus";
